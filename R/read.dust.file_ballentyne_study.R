#' Read Ballantyne expanded data from a dust expanded tabulation sheet saved from .xlsx format
#'
#' XXXX
#'
...
#'
#' @export
read.dust.file_ballantyne_study<-function(fpath)
{
  ...
  sc7.22<-as.character(dat[65,1]) # New Particles/Grains subclasses
  sc7.23<-as.character(dat[66,1])
  sc7.24<-as.character(dat[67,1])
  sc7.25<-as.character(dat[68,1])
  sc7.26<-as.character(dat[69,1])
  sc7.27<-as.character(dat[70,1])
  sc7.28<-as.character(dat[71,1])
  sc7.29<-as.character(dat[72,1])
  sc7.30<-as.character(dat[73,1])
  sc7.31<-as.character(dat[74,1])
  #Fiber attributes
  ...
  col.subclass<-rbind(
    ...
    matrix(rep(sc7.22,length(cl7.attr)),nrow=length(cl7.attr),ncol=1),
    matrix(rep(sc7.23,length(cl7.attr)),nrow=length(cl7.attr),ncol=1),
    matrix(rep(sc7.24,length(cl7.attr)),nrow=length(cl7.attr),ncol=1),
    matrix(rep(sc7.25,length(cl7.attr)),nrow=length(cl7.attr),ncol=1),
    matrix(rep(sc7.26,length(cl7.attr)),nrow=length(cl7.attr),ncol=1),
    matrix(rep(sc7.27,length(cl7.attr)),nrow=length(cl7.attr),ncol=1),
    matrix(rep(sc7.28,length(cl7.attr)),nrow=length(cl7.attr),ncol=1),
    matrix(rep(sc7.29,length(cl7.attr)),nrow=length(cl7.attr),ncol=1),
    matrix(rep(sc7.30,length(cl7.attr)),nrow=length(cl7.attr),ncol=1),
    matrix(rep(sc7.31,length(cl7.attr)),nrow=length(cl7.attr),ncol=1)
  )
  col.attributes<-rep(cl7.attr,31) ####
